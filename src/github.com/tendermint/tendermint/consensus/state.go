...
func (cs *ConsensusState) createProposalBlock() (block *types.Block, blockParts *types.PartSet) {
	...
	block, parts := cs.state.MakeBlock(cs.Height, txs, commit, cs.privValidator.GetAddress(), rewardAddr, cs.state.LastAllocation)
...
func (cs *ConsensusState) defaultSetProposal(proposal *types.Proposal) error {
	...
	if !cs.currentProposer.PubKey.VerifyBytes(proposal.SignBytes(cs.state.ChainID), proposal.Signature) {
