...
//_McDelChairperson This is a method of Ballot
func (b *Ballot) _McDelChairperson() {
	b.sdk.Helper().StateHelper().McDelete("/chairperson")
}
...
//_McDelProposals This is a method of Ballot
func (b *Ballot) _McDelProposals() {
	b.sdk.Helper().StateHelper().McDelete("/proposals")
}
